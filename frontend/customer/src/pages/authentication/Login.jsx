...
const Login = () => {
  ...
  return (
    <div className="sm:pt-5 2xl:pt-10">
  <div className="max-w-xl w-full mx-auto bg-white">
    <form className="w-full flex flex-col items-center border px-5 py-10 shadow-lg rounded-2xl">
      <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-center animate-bounce duration-1000 ease-in-out">
      ...
      <div className="w-full sm:w-[80%] mx-auto text-sm space-y-2 text-justify">
        <p>
